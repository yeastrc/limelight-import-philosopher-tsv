...
public class MatchedProteinsBuilder {
	 ...
	 * @throws Exception
	 */
	public void buildMatchedProteins( LimelightInput limelightInputRoot, File fastaFile, Collection<PhilosopherReportedPeptide> reportedPeptides ) throws Exception {
	...
	private Collection<PeptideObject> getNakedPeptideObjectsForReportedPeptides( Collection<PhilosopherReportedPeptide> cometPeptides ) {

		Collection<PeptideObject> nakedPeptideObjects = new HashSet<>();

		for( PhilosopherReportedPeptide reportedPeptide : cometPeptides ) {
